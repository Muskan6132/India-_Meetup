...
const Faq = () => {
    ...
    <div class={classes.tab}>
      ...
      <label for="acc4">
        <h2>05</h2>
        <h3>What do you think is the most important thing that can be done to improve the industry’s image?</h3>
      </label>
            <div class={classes.content}>
        <p>-Educate the public about the importance of tourism and its impact on the economy.
          -Encourage sustainable tourism practices.
          -Highlight the positive aspects of tourism, such as its ability to create jobs and generate income.
          -Promote responsible tourism initiatives.
          -Support local communities and businesses affected by tourism.  
